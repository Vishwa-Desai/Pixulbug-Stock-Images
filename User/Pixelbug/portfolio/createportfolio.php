    ...
    <body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="header-page-locator">
                            <ul>
                                <li><a href="index.html">Home /</a> Create Portfolio</li>
                            </ul>
                        </div>
                    </div>
                </div>
		...
		<div class="loginregistration-area pt-100 pb-100">
                        ...
                        <div class="registration-area">
                            ...
                            <form action="createportfolio.php" method="post" enctype="multipart/form-data">
                                <fieldset>
								<div class="col-sm-12">
									...
									<div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="p-pic"/>
                                        </div>
                                    </div>
								<div class="col-sm-12">
                                        <div class="form-group">
                                            <label>Describe Yourself</label>
                                            <textarea name="describe" cols=60 rows=7 class="form-control"></textarea>
                                        </div>
                                    </div>	
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label>Skills</label>
                                            <textarea name="skills" cols=60 rows=5 class="form-control"></textarea>
                                        </div>
                                    </div>
									<div class="col-sm-12">
                                        <div class="form-group">
                                            <label>Experience</label>
                                            <textarea name="exp" cols=60 rows=5 class="form-control"></textarea>
                                        </div>
                                    </div>
                               	 <div class="col-sm-12">
                                        <div class="form-group">
