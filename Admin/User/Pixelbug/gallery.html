                    ...
                    <div class="col-md-12">
                        <div class="gridFilter portfolio-menu text-center">
                            <ul>
                                ...
                                <li data-filter=".theme">Nature</li>
                                <li data-filter=".plugin">Human</li>
                                <li data-filter=".template">Abstract</li>
                                <li data-filter=".html">Monochrome</li>
                                <li data-filter=".graphics">Colours</li>
                            </ul>
                        </div><!-- .gridFilter end-->
                        <div class="row grid">
...
<!-- Mirrored from rstheme.com/products/html/shooter/shooter-html/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Dec 2019 08:46:14 GMT -->
</html>