			...
			<div id="page-wrapper">
				<div class="row page-titles">
					<div class="col-md-5 align-self-center">
						<h3 class="text-themecolor">Accepted Photos</h3>
					</div>
					...
					<div class="table-responsive">
						...
						<ul class="pagination"> 
							...
							for ($i=1; $i<=$total_pages; $i++) { 
							  if ($i==$pn) { 
								  $pagLink .= "<li class='active'><a href='accepted-photos.php?page="
																	.$i."'>".$i."</a></li>"; 
							  }             
							  else  { 
								  $pagLink .= "<li><a href='accepted-photos.php?page=".$i."'> 
																	".$i."</a></li>";   
							  } 
							};   
							echo $pagLink;   
	...
	<div class="job-info">
										<?php
											...
											function get()
											{
												...
												$start_from = ($pn-1) * $limit;   
												$c=0;
												$select="select photo_id,photo_name,upload_on,c1.cat_name,filename,c.profilename from photo2 p inner join contributor c on p.c_id=c.c_id inner join category c1 on c1.cat_id=c.cat_id LIMIT $start_from, $limit";
												...
												<td>	
												<form action="Upload_me.php" method="post" enctype="multipart/form-data">
												<input type="file" name="file"> <br>
												<input type="submit" name="submit" style="height:30px;width:100px;background-color:#cc0033;" value="Upload"> </form>
												</td>
												 <?php 
